...
from ofdft_normflows.functionals_new import _kinetic, _nuclear, _hartree, _exchange, cusp_condition
...
def main():
    ...
    global CKPT_DIR
    global FIG_DIR
    CKPT_DIR = f"Results/H2_{t}-{v_pot}-{h_pot}_new"
