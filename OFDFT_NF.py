...
def training(mol_name: str,
    ...
    model_rev = GCNF(3, nn,xyz_nuclei=mu, z_one_hot=z_one_hot, bool_neg=False)
    model_fwd = GCNF(3, nn,xyz_nuclei=mu, z_one_hot=z_one_hot, bool_neg=True)
    ...
    if prior_distribution.lower() == 'pro_mol':
        prior_dist =ProMolecularDensity(z.ravel(), mu)
    elif prior_distribution.lower() == 'uni_mol':
    ...
    if  optimizer.lower() == 'adam':
        ...
        optimizer = optax.chain(
            optax.clip_by_global_norm(1.0),
            optax.yogi(learning_rate=lr_sched),
        ) 
...
def main():
    ...
    parser.add_argument("--mol_name", type=str, default='C27H46O',
                        help="molecule name")
    ...
    parser.add_argument("--nn", type=int, default=384,
                        help="Neural network architecture")
    parser.add_argument("--opt", type=str, default='adam',
                        help="optimizer")
    parser.add_argument("--dist", type=str, default='pro_mol',
                        help="prior_distribution")
    ...
    training(mol_name,kin, v_pot, h_pot, x_pot,c_pot, batch_size,
             ...
             epochs, lr, nn, bool_params, sched_type,optimizer,prior_distribution)
